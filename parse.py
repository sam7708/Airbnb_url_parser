...
class House_sparse(object):
    ...
    def __init__(self):
        ...
        parser.add_argument("-f", "--filename", help="set output filename", dest="filename", default="house.csv")
        ...
        self.key="d306zoyjsyarp7ifhu67rjxn52tv0t20"
    ...
    def Start_sparse(self):
        ...
        for listing_id in data:
            self.njobs-=1
            if(data[listing_id]['avg_rating']==None):
                self.deadjobs+=1
            print(self.njobs,self.deadjobs)
    ...
    def parse(self,key,listing_id):
        ...
        if month_data_list == None:
            return
        #https://www.airbnb.com.tw/api/v2/pdp_listing_details/33928980?_format=for_rooms_show&_p3_impression_id=p3_1575989659_RtBMYTzq9a5iHGx5&key=d306zoyjsyarp7ifhu67rjxn52tv0t20&
        house_url = 'https://www.airbnb.com.tw/api/v2/pdp_listing_details/%s?_format=for_rooms_show&_p3_impression_id=p3_1575989659_RtBMYTzq9a5iHGx5&key=d306zoyjsyarp7ifhu67rjxn52tv0t20&' % (listing_id)
...
ybar.place(x=560, y=210, anchor='nw',height=320) 
log_entry = tk.Text(width=75,yscrollcommand=ybar.set, wrap='none')
log_entry.place(x=25, y=210, anchor='nw') 
...
if __name__ == "__main__":
    ...
    progressbar = tk.Text(height=1)
    progressbar.configure(background='white')
    progressbar.place(x=25, y=180, anchor='nw')
